...
def main(
    ...
    class InvertedPendulumV2(MassDampingENVInvPend):
        def __init__(self, task=0):
    ...
    elif env_name in "InvertedPendulumV2":
        env_class = InvertedPendulumV2
    else:
        raise NotImplementedError("Only HopperV2/HalfCheetahV2/Walker2DV2/InvertedPendulumV2 accepted")
